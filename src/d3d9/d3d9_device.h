...
namespace dxvk {
  ...
  public:
    ...
    /**
     * \brief Uploads the given texture subresource from it's local system memory copy.
     */
    HRESULT FlushImage(
            D3D9CommonTexture*      pResource,
            UINT                    Subresource);
     ...
     * to the image of the destination tesxture.
     */
    ...
    /**
     * \brief Uploads the given buffer from it's local system memory copy.
     */
    HRESULT FlushBuffer(
            D3D9CommonBuffer*       pResource);
  ...
  private:
    ...
    /**
     * \brief Writes data to the given pointer and zero any access buffer space
     */
